object Frm_CadForn: TFrm_CadForn
  Left = 219
  Top = 140
  ...
  object Notebook1: TNotebook
    ...
    object TPage
      ...
      object Label5: TLabel
        ...
        Height = 16
        Align = alTop
        Caption = 'Menu Cadatro de Fornecedores'
        Color = clNavy
        Font.Charset = ANSI_CHARSET
        Font.Color = clWhite
        Font.Height = -15
      ...
      object Ed_codforne: TEdit
        ...
        ParentFont = False
        TabOrder = 0
        OnExit = Ed_codforneExit
        OnKeyDown = Ed_codforneKeyDown
        OnKeyPress = Ed_codforneKeyPress
      end
      object Ed_inscMuni: TEdit
        ...
        ParentFont = False
        TabOrder = 5
        OnKeyDown = Ed_inscMuniKeyDown
        OnKeyPress = Ed_inscMuniKeyPress
      end
      ...
      object Ed_End: TEdit
        ...
        ParentFont = False
        TabOrder = 6
        OnKeyDown = Ed_EndKeyDown
        OnKeyPress = Ed_EndKeyPress
      end
      object Insc_est: TEdit
        ...
        ParentFont = False
        TabOrder = 4
        OnKeyDown = Insc_estKeyDown
        OnKeyPress = Insc_estKeyPress
      end
      object Ed_Bairro: TEdit
        ...
        ParentFont = False
        TabOrder = 7
        OnKeyDown = Ed_BairroKeyDown
        OnKeyPress = Ed_BairroKeyPress
      end
      object Ed_Fone_Comer: TEdit
        ...
        ParentFont = False
        TabOrder = 11
        OnKeyDown = Ed_Fone_ComerKeyDown
        OnKeyPress = Ed_Fone_ComerKeyPress
      end
      object Ed_FoneRes: TEdit
        ...
        ParentFont = False
        TabOrder = 12
        OnKeyDown = Ed_FoneResKeyDown
        OnKeyPress = Ed_FoneResKeyPress
      end
      object Ed_Cidade: TEdit
        ...
        ParentFont = False
        TabOrder = 8
        OnKeyDown = Ed_CidadeKeyDown
        OnKeyPress = Ed_CidadeKeyPress
      end
      object Cbx_Estado: TComboBox
        ...
        ParentFont = False
        TabOrder = 9
        OnKeyDown = Cbx_EstadoKeyDown
        OnKeyPress = Cbx_EstadoKeyPress
        Items.Strings = (
          'Acre'
          'Alagoas'
          'Amap'#225
      ...
      object edmak_CEP: TMaskEdit
        ...
        TabOrder = 10
        Text = '     -   '
        OnKeyDown = edmak_CEPKeyDown
        OnKeyPress = edmak_CEPKeyPress
      end
      object ed_Cgc_cpf: TMaskEdit
        ...
        OnKeyDown = ed_Cgc_cpfKeyDown
        OnKeyPress = ed_Cgc_cpfKeyPress
      end
